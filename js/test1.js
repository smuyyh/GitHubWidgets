...
function fetchRepos(a, b) {
	getJSON("https://api.github.com/users/JustWayward/repos",
    function(a) {
...
function updateUserDetails(a, b) {
    ...
    appendToWidget(b + " .gh-widget-stats", "div", "gh-widget-item", '<div class="count"><a class="gh-widget-link" target="new" href="' + a.html_url + '/?tab=repositories">' + a.public_repos + '</a></div><div class="stat-name">Repos</div>');
